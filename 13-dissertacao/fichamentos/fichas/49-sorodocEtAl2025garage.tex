...
Usar GaRAGe para justificar a avaliação de deflexão, suficiência e atribuição. Os valores de factualidade, F1 e verdadeiros positivos permanecem circunscritos ao benchmark e não são metas universais.
