...
\campo{Método ou estrutura}
Desenho, dados e evidências. Para textos institucionais, explicitar estrutura e recorte.

\campo{Resultado principal ou orientação principal}
Registrar o achado, a comparação e as condições de avaliação. Em textos institucionais, distinguir orientação e resultado esperado de resultado medido.
...
\textbf{Fonte:} registrar ressalvas declaradas.
\textbf{Análise da ficha:} explicitar limites observados na versão consultada, distinguindo ausência de informação e ausência de execução.

\campo{Aproveitamento na dissertação · proposta}
\textbf{Destino:} seção e hipótese, quando pertinente.
\textbf{Uso:} argumento ou escolha que a fonte pode sustentar, com seu limite de aplicação.
