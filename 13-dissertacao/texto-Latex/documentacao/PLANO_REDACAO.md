...
- [ ] Responder à pergunta e aos objetivos no Capítulo 8.

## Fase 4 — fechamento

- [ ] Redigir resumo e abstract depois de concluir os capítulos.
- [ ] Conferir consistência entre citações e `referencias.bib`.
- [ ] Preencher ficha catalográfica e dados de banca.
- [ ] Revisar todas as figuras, tabelas, quadros, fontes e chamadas no texto.
